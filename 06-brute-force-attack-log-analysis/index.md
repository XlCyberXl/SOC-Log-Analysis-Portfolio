...
* **Observation**: The frequency and speed of the login attempts were faster than what would be humanly possible.

[![Step 1](images/brute_force_attack_log_analysis_step1.png)](images/brute_force_attack_log_analysis_step1.png)
...
[![Step 2](images/brute_force_attack_log_analysis_step2.png)](images/brute_force_attack_log_analysis_step2.png)

### Step 3: Determined When the Brute Force Attack was Successful
I identified an **HTTP 302 response** on **26/Apr/2023 at 21:44:03**, which confirmed the exact date and time the attacker successfully breached the account.

[![Step 3](images/brute_force_attack_log_analysis_step3.png)](images/brute_force_attack_log_analysis_step3.png)

---

## 🏁 Project Wrap-Up / Conclusion
Through systematic log analysis, I detected a brute force attack originating from IP `146.214.73.240`. While the initial logs showed rapid failed attempts, the discovery of an **HTTP 302 response** confirmed that the attack was ultimately successful. 
...
* **Incident Timeline Reconstruction**: Pinpointing the exact moment of compromise.
